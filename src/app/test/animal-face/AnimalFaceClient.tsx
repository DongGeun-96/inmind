...
const Q: CategoryQuestion[] = [
  ...
  { text: '처음 보는 사람이 너한테 두러보는 부위는?', options: [
    { label: '밝게 웃는 입', weights: { puppy: 1 } },
    { label: '눈매와 테이블 라인', weights: { cat: 1 } },
    { label: '동그란 볼과 입술', weights: { rabbit: 1 } },
    { label: '날카로운 턴의 레임', weights: { wolf: 1 } },
    { label: '길고 우아한 목선', weights: { deer: 1 } },
    { label: '볼살과 컵컵한 눈빛', weights: { hamster: 1 } },
  ]},
  { text: '나의 웃음소리는?', options: [
    { label: '하하하! 크고 밝음', weights: { puppy: 1 } },
    { label: '피식·펏 짧음', weights: { cat: 1 } },
    { label: '킥킥 근두감 있는 웃음', weights: { rabbit: 1 } },
    { label: '잘 안 웃음. 웃으면 눈으로', weights: { wolf: 1 } },
    { label: '소리 없이 미소 타입', weights: { deer: 1 } },
    { label: '폭폭폭 없이 웃음 폭발', weights: { hamster: 1 } },
  ]},
  { text: '카메라 앞에서 나는?', options: [
    { label: '선한 쑥쑥형 웃음', weights: { puppy: 1 } },
    { label: '무표정 시크 감성샷', weights: { cat: 1 } },
    { label: '수줍은 미소 잡기', weights: { rabbit: 1 } },
    { label: '정면을 날카롭게 바라봄', weights: { wolf: 1 } },
    { label: '설거팃한 감성 샷', weights: { deer: 1 } },
    { label: '사진마다 다른 이상한 자세', weights: { hamster: 1 } },
  ]},
  { text: '사람들이 당신의 커플링으로 왜 놀래하나요?', options: [
    { label: '파워 부리면 착하게 오는 타입', weights: { puppy: 1 } },
    { label: '별 말 없어도 손 잡아주는 타입', weights: { cat: 1 } },
    { label: '상대를 천사로 멈들고 맞춰주는 타입', weights: { rabbit: 1 } },
    { label: '말없이 하나하나 해주는 타입', weights: { wolf: 1 } },
    { label: '분위기로 논실주는 타입', weights: { deer: 1 } },
    { label: '하루 종일 웃기기만 하는 타입', weights: { hamster: 1 } },
  ]},
  { text: '내 방/호먼 화면 분위기는?', options: [
    { label: '알따까거 친근한 테마', weights: { puppy: 1 } },
    { label: '모노크롬한 전체 다크테마', weights: { cat: 1 } },
    { label: '파스텔과 꽃, 디퓨저 조명', weights: { rabbit: 1 } },
    { label: '믭정리되고 인더스트리한 무드', weights: { wolf: 1 } },
    { label: '감성 영화 스틸일 조명', weights: { deer: 1 } },
    { label: '포스터/피규어 장난감 가득', weights: { hamster: 1 } },
  ]},
  { text: '친구가 너를 설명할 때 가장 자주 나오는 단어?', options: [
    { label: '다정이', weights: { puppy: 1 } },
    { label: '쿨가이/쿨걸', weights: { cat: 1 } },
    { label: '순둥이', weights: { rabbit: 1 } },
    { label: '갑언이', weights: { wolf: 1 } },
    { label: '분위기 메이커', weights: { deer: 1 } },
    { label: '웃긴이', weights: { hamster: 1 } },
  ]},
];
