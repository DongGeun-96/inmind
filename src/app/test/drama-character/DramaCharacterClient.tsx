...
const Q: CategoryQuestion[] = [
  ...
  { text: '너의 사랑 대사 한 마디?', options: [
    { label: '"내가 지켜줄게."', weights: { lead: 1 } },
    { label: '"내가 더 잘할 수 있었는데..."', weights: { second: 1 } },
    { label: '"..."', weights: { mystery: 1 } },
    { label: '"사랑? 그거 나한테 좀 맡겨봐ㅋㅋ"', weights: { comic: 1 } },
    { label: '"내가 너한테 필요한 사람이 되어줄게."', weights: { villain: 1 } },
    { label: '"오늘도 수고했어."', weights: { healer: 1 } },
  ]},
  { text: '내 드라마의 배경은?', options: [
    { label: '재벌/로펌 화려한 오피스', weights: { lead: 1 } },
    { label: '감성 있는 동네 빙숫집', weights: { second: 1 } },
    { label: '비밀스러운 고아원/수도원', weights: { mystery: 1 } },
    { label: '시끌벅적한 고등학교', weights: { comic: 1 } },
    { label: '지하세계/기업 암투극', weights: { villain: 1 } },
    { label: '시골의 마당 있는 집', weights: { healer: 1 } },
  ]},
  { text: '드라마 속 내 패션은?', options: [
    { label: '정장/코트 세련됨', weights: { lead: 1 } },
    { label: '니트/셔츠 내추럴', weights: { second: 1 } },
    { label: '전체 블랙 뭇 시크', weights: { mystery: 1 } },
    { label: '맛시원 맥시 후드티', weights: { comic: 1 } },
    { label: '블랙 라이더 재킷', weights: { villain: 1 } },
    { label: '내추럴 린넨/파스텔', weights: { healer: 1 } },
  ]},
  { text: '가장 많이 찍힐 명장면은?', options: [
    { label: '빗속 키스/프러포즈', weights: { lead: 1 } },
    { label: '눈물 참으며 애끓는 장면', weights: { second: 1 } },
    { label: '조용히 뒤돌아 사라지는 장면', weights: { mystery: 1 } },
    { label: '넘어지면서 유행하는 개그 장면', weights: { comic: 1 } },
    { label: '복수의 순간 노려보는 장면', weights: { villain: 1 } },
    { label: '따뜻한 포옹', weights: { healer: 1 } },
  ]},
  { text: '극중 내가 듣는 대사?', options: [
    { label: '"너는 빛나는 사람이야."', weights: { lead: 1 } },
    { label: '"니가 더 아까워."', weights: { second: 1 } },
    { label: '"너 도대체 누구야?"', weights: { mystery: 1 } },
    { label: '"너 때문에 웃었다."', weights: { comic: 1 } },
    { label: '"넌 위험한 사람이야."', weights: { villain: 1 } },
    { label: '"옆에만 있어줘도 좋아."', weights: { healer: 1 } },
  ]},
  { text: '시청자가 나에 대해 가장 많이 하는 말은?', options: [
    { label: '"너무 멋있어 오빵/언니"', weights: { lead: 1 } },
    { label: '"제발 얘랑 이어져줘..."', weights: { second: 1 } },
    { label: '"얘 정체가 뭐야"', weights: { mystery: 1 } },
    { label: '"얘 없으면 못 봐ㅋㅋㅋ"', weights: { comic: 1 } },
    { label: '"빌런인데 왜이렇게 설레냐"', weights: { villain: 1 } },
    { label: '"얘 볼 때마다 눈물나"', weights: { healer: 1 } },
  ]},
];
